...
class Recommender:
        ...
        for product_id in product_ids:
            for with_id in product_ids:
                ...
                if product_id != with_id:
                    conn.zincrby(self.get_product_key(product_id), 1, with_id)
    ...
    def suggest_products_for(self, products: list, max_results=6):
        ...
        if len(products) == 1:
            ...
            suggestions = conn.zrange(tmp_key, 0, -1, desc=True)[:max_results]
    ...
    def clear_purchases(self):
        ...
        for id in products.iterator():
            conn.delete(self.get_product_key(id))
